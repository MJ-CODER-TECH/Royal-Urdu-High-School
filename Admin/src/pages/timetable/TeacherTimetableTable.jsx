...
import { Clock, MapPin, BookOpen, CalendarX, GraduationCap } from "lucide-react";
...
const TeacherTimetableTable = ({ timetable = [], loading = false }) => {
  if (loading) {
    return (
    ...
    return (
      <div className="flex h-64 flex-col items-center justify-center rounded-xl border border-dashed border-slate-300 bg-slate-50 p-6 text-center">
        ...
        <p className="mt-1 text-xs text-slate-500">
          Select a teacher and academic year to view their assigned schedule.
        </p>
      </div>
    );
  }
